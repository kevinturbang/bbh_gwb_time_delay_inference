...
def getInjections(sample_limit=10000,reweight=False,weighting_function=reweighting_function_arlnm1):
    ...
    injectionFile = "/home/kevin.turbang/public_html/PROJECTS/gwb_cbc_pop_modeling/time_delay_tdmin_CBC_GWB_MC_integral_MD/code/injectionDict_FAR_1_in_1.pickle"
...
def getSamples(sample_limit=1000,bbh_only=True,reweight=True,weighting_function=reweighting_function_arlnm1):
    ...
    # Dicts with samples:
    sampleDict = np.load("/home/kevin.turbang/public_html/PROJECTS/gwb_cbc_pop_modeling/time_delay_tdmin_CBC_GWB_MC_integral_MD/code/sampleDict_FAR_1_in_1_yr.pickle",allow_pickle=True)
